...
namespace OnlineVotingWebApp.Migrations
{
    ...
    [Migration("20230426131105_RemovedIsSelectedColumnInTransactionsTable")]
    partial class RemovedIsSelectedColumnInTransactionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineVotingWebApp.Models.ActivityLog", b =>
                {
                    ...
                    b.HasKey("ActivityLogId")
                        .HasName("PK__ActivityLog_ActivityLogId");
            ...
            modelBuilder.Entity("OnlineVotingWebApp.Models.Candidate", b =>
                {
                    ...
                    b.HasKey("CandidateId")
                        .HasName("PK__Candidate_CandidateId");
            ...
            modelBuilder.Entity("OnlineVotingWebApp.Models.CandidatePosition", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CandidatePositionId"));

                    b.Property<string>("CandidatePositionName")
                        .IsRequired()
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasKey("CandidatePositionId")
                        .HasName("PK_CandidatePosition_CandidatePositionId");
            ...
            modelBuilder.Entity("OnlineVotingWebApp.Models.Candidate", b =>
                {
                    b.HasOne("OnlineVotingWebApp.Models.CandidatePosition", "CandidatePosition")
                        .WithMany("Candidates")
            ...
            modelBuilder.Entity("OnlineVotingWebApp.Models.Vote", b =>
                {
                    b.HasOne("OnlineVotingWebApp.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Vote")
                        .HasForeignKey("OnlineVotingWebApp.Models.Vote", "VoterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
